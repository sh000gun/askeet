...
/**
 * Base class that represents a query for the 'ask_user' table.
 *
 *
 *
 ...
 *
 * @method     ChildUserQuery leftJoinAnswer($relationAlias = null) Adds a LEFT JOIN clause to the query using the Answer relation
 * @method     ChildUserQuery rightJoinAnswer($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Answer relation
 * @method     ChildUserQuery innerJoinAnswer($relationAlias = null) Adds a INNER JOIN clause to the query using the Answer relation
 *
 * @method     ChildUserQuery joinWithAnswer($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Answer relation
 *
 * @method     ChildUserQuery leftJoinWithAnswer() Adds a LEFT JOIN clause and with to the query using the Answer relation
 * @method     ChildUserQuery rightJoinWithAnswer() Adds a RIGHT JOIN clause and with to the query using the Answer relation
 * @method     ChildUserQuery innerJoinWithAnswer() Adds a INNER JOIN clause and with to the query using the Answer relation
 *
 ...
 *
 * @method     ChildUserQuery joinWithInterest($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Interest relation
 *
 * @method     ChildUserQuery leftJoinWithInterest() Adds a LEFT JOIN clause and with to the query using the Interest relation
 * @method     ChildUserQuery rightJoinWithInterest() Adds a RIGHT JOIN clause and with to the query using the Interest relation
 * @method     ChildUserQuery innerJoinWithInterest() Adds a INNER JOIN clause and with to the query using the Interest relation
 *
 * @method     ChildUserQuery leftJoinRelevancy($relationAlias = null) Adds a LEFT JOIN clause to the query using the Relevancy relation
 * @method     ChildUserQuery rightJoinRelevancy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Relevancy relation
 * @method     ChildUserQuery innerJoinRelevancy($relationAlias = null) Adds a INNER JOIN clause to the query using the Relevancy relation
 *
 * @method     ChildUserQuery joinWithRelevancy($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Relevancy relation
 *
 * @method     ChildUserQuery leftJoinWithRelevancy() Adds a LEFT JOIN clause and with to the query using the Relevancy relation
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Entity\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'askeet', $modelName = '\\App\\Entity\\User', $modelAlias = null)
    {
     ...
     * $query->filterBySha1Password('%fooValue%', Criteria::LIKE); // WHERE sha1_password LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterBySha1Password($sha1Password = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_SHA1_PASSWORD, $sha1Password, $comparison);
    }
     ...
     *
     * @param \App\Entity\Question|ObjectCollection $question the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByAnswer($answer, $comparison = null)
    {
        if ($answer instanceof \App\Entity\Answer) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $answer->getUserId(), $comparison);
    ...
    public function filterByInterest($interest, $comparison = null)
    {
        if ($interest instanceof \App\Entity\Interest) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $interest->getUserId(), $comparison);
    ...
    public function filterByRelevancy($relevancy, $comparison = null)
    {
        if ($relevancy instanceof \App\Entity\Relevancy) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $relevancy->getUserId(), $comparison);
