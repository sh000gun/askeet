...
/**
 * Base class that represents a row from the 'ask_interest' table.
 *
 *
 *
...
abstract class Interest implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Entity\\Map\\InterestTableMap';
    ...
    /**
     * Initializes internal state of App\Entity\Base\Interest object.
     */
    ...
    public function setQuestionId($v)
    {
        ...
        if ($this->question_id !== $v) {
            $this->question_id = $v;
            $this->modifiedColumns[InterestTableMap::COL_QUESTION_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[InterestTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[InterestTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InterestTableMap::translateFieldName('QuestionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->question_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InterestTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InterestTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InterestTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Entity\\Interest'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(InterestTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(InterestTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(InterestTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_QUESTION_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO ask_interest (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Entity\Interest
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Entity\Interest The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_QUESTION_ID)) {
            $criteria->add(InterestTableMap::COL_QUESTION_ID, $this->question_id);
        }
        if ($this->isColumnModified(InterestTableMap::COL_USER_ID)) {
            $criteria->add(InterestTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(InterestTableMap::COL_CREATED_AT)) {
            $criteria->add(InterestTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(InterestTableMap::COL_UPDATED_AT)) {
            $criteria->add(InterestTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        ...
        //relation ask_interest_fk_3a3644 to table ask_question
        ...
        //relation ask_interest_fk_c9f24d to table ask_user
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Entity\Interest (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Entity\Interest Clone of current object.
     * @throws PropelException
     */
    ...
    public function getQuestion(ConnectionInterface $con = null)
    {
        if ($this->aQuestion === null && ($this->question_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aQuestion->addInterests($this);
             */
        }
    ...
    {
        if (null !== $this->aQuestion) {
            $this->aQuestion->removeInterest($this);
        }
        if (null !== $this->aUser) {
     ...
     *
     * @return     $this|ChildInterest The current object (for fluent API support)
     */
